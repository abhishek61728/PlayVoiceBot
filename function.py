...
async def generate_cover_square(message, title, artist, duration, thumbnail):
    ...
    image2 = Image.open("Play/PlayVoice/PlayVoiceBot.png")
    ...
    font = ImageFont.truetype("Play/PlayVoice/Play.font", 20)
...
async def generate_cover(message, title, views, duration, thumbnail):
    ...
    image1 = Image.open("./background.png")
    image2 = Image.open("Play/PlayVoice/playground.png")
    ...
    img = Image.open("temp.png")
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("Play/PlayVoice/play.font", 32)
